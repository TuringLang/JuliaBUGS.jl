...
JuliaBUGS.@bugs_primitive Bernoulli Beta Categorical censored Diagonal Dirichlet fill Gamma InverseGamma LKJ ones MvNormal Normal product_distribution sum truncated zeros
