...
data = (
    nDate = 16,
    theta.max = 21000,
    X = [3275, 3270, 3400, 3190, 3420, 3370, 3435, 3160,
        3340, 3270, 3200, 3390, 3480, 3250, 3115, 3460],
...
inits = (
    theta = [3700, 3600, 3550, 3504, 3586, 3800, 3529, 3525,
    3500, 3500, 3402, 3542, 3492, 3618, 3148, 3638]
)

inits_alternative = (
    theta = [3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000,
