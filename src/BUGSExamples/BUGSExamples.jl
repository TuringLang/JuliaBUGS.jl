...
function load_example_volume(volume_num::Int)
    if volume_num == 1
        include("./Volume_1/1_Rats.jl")
        include("./Volume_1/2_Pumps.jl")
        include("./Volume_1/3_Dogs.jl")
        include("./Volume_1/4_Seeds.jl")
        include("./Volume_1/5_Surgical.jl")
        include("./Volume_1/6_Magnesium.jl")
        include("./Volume_1/7_Salm.jl")
        include("./Volume_1/8_Equiv.jl")
        include("./Volume_1/9_Dyes.jl")
