# Original code from: https://github.com/TuringLang/SymbolicPPL.jl/blob/master/src/bugsast.jl
...
"""
macro bugsast(expr)
    return Meta.quot(linkfunction(warn_link_function(bugsast(expr, __source__))))
end
...
macro bugsmodel_str(s::String)
    ...
    try
        ...
        return Meta.quot(linkfunction(bugsast(expr, __source__)))
    catch e
