...
# Automatic Marginalization in Mixed Discrete-Continuous Models {#Automatic-Marginalization-in-Mixed-Discrete-Continuous-Models}
...
## Marginalization Target {#Marginalization-Target}
...
## Naive Enumeration {#Naive-Enumeration}
...
## The Solution: Strategic Caching {#The-Solution:-Strategic-Caching}
...
## The Frontier Concept {#The-Frontier-Concept}
...
## Frontier Evolution {#Frontier-Evolution}
...
## Impact of Order {#Impact-of-Order}
...
## Precomputing Frontier Keys {#Precomputing-Frontier-Keys}
...
## Example with order $z, x, a, b, c, d$ {#Example-with-order-z,-x,-a,-b,-c,-d}
...
## Factor Graph Representation {#Factor-Graph-Representation}
...
## Message Passing with Elimination Order: $X$, then $(C,Z)$ {#Message-Passing-with-Elimination-Order:-X,-then-C,Z}
...
## Final Marginal Likelihood {#Final-Marginal-Likelihood}
...
## Which Topological Orders Yield This Factorization? {#Which-Topological-Orders-Yield-This-Factorization?}
...
## Frontier Evolution for Order $X, A, B, C, Z, D$ {#Frontier-Evolution-for-Order-X,-A,-B,-C,-Z,-D}
...
## Messages ARE the DP Cache Entries {#Messages-ARE-the-DP-Cache-Entries}
...
## Two Perspectives on the Same Algorithm {#Two-Perspectives-on-the-Same-Algorithm}

### Top-down with memoization (our frontier caching): {#Top-down-with-memoization-our-frontier-caching:}
...
### Bottom-up tabulation (factor graph message passing): {#Bottom-up-tabulation-factor-graph-message-passing:}
...
## Analogy: Two Ways to Compute Fibonacci {#Analogy:-Two-Ways-to-Compute-Fibonacci}
