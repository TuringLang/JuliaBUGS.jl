...
# Parallel and Distributed Sampling {#Parallel-and-Distributed-Sampling}

`AbstractMCMC` and `AdvancedHMC` support both parallel and distributed sampling.

## Parallel Sampling (Multi-threaded) {#Parallel-Sampling-Multi-threaded}
...
## Distributed Sampling (Multi-process) {#Distributed-Sampling-Multi-process}
