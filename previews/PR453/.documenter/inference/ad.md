...
## Specifying an AD Backend {#Specifying-an-AD-Backend}
...
## Available AD Backends {#Available-AD-Backends}
...
## AD Backends with `UseGraph()` Mode {#AD-Backends-with-UseGraph-Mode}
...
::: tip Control flow and compiled tapes
...
## AD Backend with `UseGeneratedLogDensityFunction()` Mode {#AD-Backend-with-UseGeneratedLogDensityFunction-Mode}
