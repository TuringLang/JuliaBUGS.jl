...
# Differences From Other BUGS Implementations {#Differences-From-Other-BUGS-Implementations}
...
## Use of generic function in distribution functions {#Use-of-generic-function-in-distribution-functions}
...
## `cumulative`, `density`, and `deviance` Functions {#cumulative,-density,-and-deviance-Functions}
...
## Use `:` for slicing when using Julia Syntax {#Use-:-for-slicing-when-using-Julia-Syntax}
...
### Compare with `nimble` {#Compare-with-nimble}
