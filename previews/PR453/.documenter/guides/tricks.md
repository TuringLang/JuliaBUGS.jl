...
# BUGS Implementation Tricks {#BUGS-Implementation-Tricks}

## Implementing Custom Distributions Without Low-Level Coding in Previous Version of BUGS {#Implementing-Custom-Distributions-Without-Low-Level-Coding-in-Previous-Version-of-BUGS}
...
### The &quot;Zeros Trick&quot; {#The-"Zeros-Trick"}
...
2. Set $\phi[i] = -\log(L[i]) + C$, where:
  ...
  - 
    $$C$$
    is a constant large enough to ensure $\phi[i] > 0$
...
### Using `dloglik` in OpenBUGS and MultiBUGS {#Using-dloglik-in-OpenBUGS-and-MultiBUGS}
...
## Implementing Custom Prior Distributions {#Implementing-Custom-Prior-Distributions}
...
## Working with Predictions and Complex Models {#Working-with-Predictions-and-Complex-Models}

### Predicting New Observations {#Predicting-New-Observations}
...
### Handling Model Mixtures of Different Complexity {#Handling-Model-Mixtures-of-Different-Complexity}
...
### Managing Random Set Sizes {#Managing-Random-Set-Sizes}
