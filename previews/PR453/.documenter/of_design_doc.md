...
# Design Document: `of` Type System for JuliaBUGS {#Design-Document:-of-Type-System-for-JuliaBUGS}
...
### 1. Type-Based Design {#1.-Type-Based-Design}
...
### 2. Type Parameter Encoding {#2.-Type-Parameter-Encoding}
...
### 3. Operations on Types {#3.-Operations-on-Types}
...
### 5. Symbolic Dimensions and Bounds {#5.-Symbolic-Dimensions-and-Bounds}
...
### Static Model Specification {#Static-Model-Specification}
...
### Model with Variable Dimensions {#Model-with-Variable-Dimensions}
...
#### Variable-order autoregressive model {#Variable-order-autoregressive-model}
...
#### Bayesian Nonparametric clustering model {#Bayesian-Nonparametric-clustering-model}
