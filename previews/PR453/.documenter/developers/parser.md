...
# BUGS Parser {#BUGS-Parser}

The macro [`@bugs`](/two_macros#@bugs) produces a Julia `Expr` object that represents the BUGS model definition.
...
## BUGS to Julia Translation {#BUGS-to-Julia-Translation}
...
### Some Notes on Error Recovery {#Some-Notes-on-Error-Recovery}
