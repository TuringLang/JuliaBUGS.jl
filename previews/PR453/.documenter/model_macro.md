...
# Defining Probabilistic Models with JuliaBUGS {#Defining-Probabilistic-Models-with-JuliaBUGS}
...
#### 1. Stochastic Parameters {#1.-Stochastic-Parameters}
...
#### 2. Constants and Covariates {#2.-Constants-and-Covariates}
...
## Type Specifications with `of` {#Type-Specifications-with-of}
...
## Creating and Using Models {#Creating-and-Using-Models}
...
### Using `unflatten` for Initialisation {#Using-unflatten-for-Initialisation}
...
## Complete Example: Hierarchical Model {#Complete-Example:-Hierarchical-Model}
...
## Important Notes and Restrictions {#Important-Notes-and-Restrictions}
