    ...
    <template #body>
      <div class="export-options-form">
        ...
        <div class="form-group">
          ...
          <BaseInput id="export-scale" type="number" v-model.number="options.scale" min="0.1" step="0.1" />
        </div>

        <template v-if="exportType === 'png' || exportType === 'jpg'">
          <div class="form-group">
            <label for="export-maxWidth">Max Width (optional):</label>
            <BaseInput id="export-maxWidth" type="number" v-model="options.maxWidth" placeholder="e.g., 1920" />
          </div>
          <div class="form-group">
            <label for="export-maxHeight">Max Height (optional):</label>
            <BaseInput id="export-maxHeight" type="number" v-model="options.maxHeight" placeholder="e.g., 1080" />
          </div>
        </template>
        ...
        <template v-if="exportType === 'jpg'">
          <div class="form-group">
            ...
            <input id="export-quality" type="range" v-model.number="options.quality" min="0" max="1" step="0.01" />
