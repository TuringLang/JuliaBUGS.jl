        ...
        <template #body>
            <div class="style-container">
                <div class="category-tabs">
                    <button :class="{ active: editingCategory === 'node' }" @click="editingCategory = 'node'">Nodes</button>
                    <button :class="{ active: editingCategory === 'edge' }" @click="editingCategory = 'edge'">Edges</button>
                </div>
                ...
                <div class="style-form" v-if="editingCategory === 'node'">
                    <div class="form-group">
                        ...
                        <BaseSelect :model-value="editingNodeType" :options="nodeTypeOptions" @update:model-value="switchNodeType($event as NodeType)" />
                    </div>
